...
extension $DcpException on DcpException {
  R when<R>({
    ...
    if (this is DcpExceptionMissingDataClassPluginImport) {
      return missingDataClassPluginImport(
        this as DcpExceptionMissingDataClassPluginImport,
      );
    }
...
class DcpExceptionPackageNotFound extends DcpException {
  DcpExceptionPackageNotFound({required this.packageName}) : super._();

  final String packageName;

  @override
  int get hashCode {
    return Object.hashAll(<Object?>[runtimeType, packageName]);
  }
...
class DcpExceptionMissingDataClassPluginImport extends DcpException {
  ...
  @override
  int get hashCode {
    return Object.hashAll(<Object?>[runtimeType, relativeFilePath]);
  }
