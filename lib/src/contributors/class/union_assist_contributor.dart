...
class UnionAssistContributor extends Object
  ...
  void _generateFromJsonFunction({
    ...
    if (sourceRange == null) {
      fileEditBuilder.addInsertion(
        1 + classNode.leftBracket.offset,
        (DartEditBuilder builder) => _writeFromJson(classElement: classElement, builder: builder),
      );
    }
  }
  ...
  //     }
  //     builder.writeln('final ${param.type.typeStringValue(enclosingImports: [])} ${param.name};');
  //   }
