...
///
///    @override
///    String toMap(Category value) => value.name;
///
///    @override
///    Category fromMap(String value) {
...
abstract class TypeConverter<InType, OutType> {
  InType fromMap(OutType value);
  OutType toMap(InType value);
}

class TypeConverterRegistrant {
  final Map<Type, TypeConverter<Object?, Object?>> _converters =
      <Type, TypeConverter<Object?, Object?>>{};
...
class _UriTypeConverter implements TypeConverter<Uri, String> {
  ...
  @override
  String toMap(Uri value) => value.toString();

  @override
  Uri fromMap(String value) => Uri.parse(value);
}
...
class _DateTimeTypeConverter implements TypeConverter<DateTime, String> {
  ...
  @override
  String toMap(DateTime value) => value.toIso8601String();

  @override
  DateTime fromMap(String value) => DateTime.parse(value);
}

/// Registrant for adding new converters used by [fromMap] and [toMap]
///
/// see also on how to register a converter [TypeConverter]
final TypeConverterRegistrant typeConverterRegistrant =
    TypeConverterRegistrant()
